...
public class VisionConstants {
    ...
    public static final String APRILTAG_LAYOUT_PATH = 
        "2025-reefscape.json";
    ...
    public static final double SINGLE_TAG_STD_DEV_BASE = 0.8;
    
    public static final double MULTI_TAG_STD_DEV_BASE = 0.3;
    
    public static final double THETA_STD_DEV_MULTIPLIER = 2.0;
